            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title d-flex align-items-center" style="gap: 10px;">
                                <span>Edit Pengguna - <?= htmlspecialchars($pengguna->nama_user, ENT_QUOTES, 'UTF-8') ?></span>
                            </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="formPengguna" action="<?= base_url('Pengguna/update/' . $pengguna->id_user) ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <!-- Kolom Utama -->
                                <div class="col-md-6 border-right">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select" id="id_role" name="id_role" required style="width: 100%">
                                            ...
                                            <?php foreach ($roles as $role): ?>
                                                <option value="<?= $role->id_role ?>" <?= set_select('id_role', $role->id_role, $pengguna->id_role == $role->id_role) ?>>
                                    ...
                                    <div id="santriFields" style="display: <?= $pengguna->id_role == 2 ? 'block' : 'none' ?>;">
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nis" name="nis" 
                                                value="<?= set_value('nis', $santri->nis ?? '') ?>">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="alamat">Alamat <span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="alamat" name="alamat" rows="2"><?= set_value('alamat', $santri->alamat ?? '') ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="no_wa" name="no_wa" 
                                                    value="<?= set_value('no_wa', $santri->no_wa ?? '') ?>" placeholder="81234567890">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" 
                                                value="<?= set_value('tanggal_lahir', $santri->tanggal_lahir ?? '') ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($pengguna->foto_user): ?>
                                            <div class="mt-2">
                                                <img src="<?= base_url('uploads/profil/' . $pengguna->foto_user) ?>" class="img-thumbnail" style="max-height: 150px;">
