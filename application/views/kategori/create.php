                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Form Tambah Kategori Pembayaran</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-kategori" action="<?= base_url('kategori/store') ?>" method="POST">
                            <div class="form-group">
                                <label for="nama_kategori">Nama Kategori <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" 
                                    placeholder="Masukkan nama kategori" maxlength="100" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi" name="deskripsi" 
                                    rows="3" placeholder="Masukkan deskripsi (opsional)"></textarea>
