                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Form Buat Tagihan</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="formTagihan" action="<?= base_url('Tagihan/store') ?>" method="POST">
                            <div class="row">
                                <!-- Kolom Kiri -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_tagihan" name="nama_tagihan"
                                            value="<?= set_value('nama_tagihan') ?>" required>
                                        <small class="form-text text-muted">Contoh: SPP Bulan Juli 2025</small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_kategori" name="id_kategori" required>
                                            ...
                                            <?php foreach ($kategori as $kat): ?>
                                                <option value="<?= $kat->id_kategori ?>" <?= set_select('id_kategori', $kat->id_kategori) ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai"
                                            value="<?= set_value('tanggal_mulai', date('Y-m-d')) ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_jatuh_tempo" name="tanggal_jatuh_tempo"
                                            value="<?= set_value('tanggal_jatuh_tempo', date('Y-m-d', strtotime('+30 days'))) ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_rekening" name="id_rekening" required>
                                            ...
                                            <?php foreach ($rekening as $rek): ?>
                                                <option value="<?= $rek->id_rekening ?>" <?= set_select('id_rekening', $rek->id_rekening) ?>>
